...
int32_t main() {
    ...
    rlr_texture_t* ta_ui = rlr_texture_load("assets/ui_texture_atlas.png", false);
    ...
    rlr_obj_sprite_create(hero_unknown, rlr_rect(ui_x + 4, ui_y + 4, 73, 73), 0);
    rlr_obj_sprite_create(ta_ui, rlr_rect(ui_x, ui_y, 286, 119), 1);
