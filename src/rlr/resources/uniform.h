...
*/
void rlr_res_uniform_update(rlr_res_t ubo, uint64_t offset, void* data, uint64_t size);

void rlr_res_uniform_bind(rlr_res_t ubo, uint8_t ubo_slot);
void rlr_res_uniform_free(rlr_res_t ubo);