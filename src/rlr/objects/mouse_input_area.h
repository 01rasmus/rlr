...
void rlr_obj_mouse_input_area_set_enabled(rlr_obj_mouse_input_area_t* mia, bool enabled);
void rlr_obj_mouse_input_area_free(rlr_obj_mouse_input_area_t* mia);